    ...
    <div className="py-12">
      <div className="container-custom max-w-2xl">
        ...
        <div className="space-y-6 mb-8">
          ...
          <div className="bg-pottery-50 p-6 rounded-lg">
            <h3 className="font-semibold text-pottery-800 mb-4">Follow Us</h3>
            <div className="flex gap-4">
              <a href="https://www.instagram.com/mahe_by_meenakshi_/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-pottery-600 hover:text-pottery-800 transition-colors">
              ...
              <a href="https://www.linkedin.com/in/meenakshi-mirajgaoker-a16ab413/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-pottery-600 hover:text-pottery-800 transition-colors">

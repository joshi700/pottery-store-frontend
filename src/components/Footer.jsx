        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-4">
              <a href="https://www.instagram.com/mahe_by_meenakshi_/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-pottery-300 hover:text-white transition-colors" aria-label="Instagram">
              ...
              <a href="https://www.linkedin.com/in/meenakshi-mirajgaoker-a16ab413/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-pottery-300 hover:text-white transition-colors" aria-label="LinkedIn">
